...
// All exercises completed in a single file using var, camelCase, and semicolons.
...
$3 + 5 * (10 / 2) - (8 - 4)$. Output the result using console.log(). */
...
Crucially, precede this injection code with a multi-line comment explaining the timing issue that occurs if this script is placed in the HTML <head> without the defer or async attributes, leading to the error "Cannot set property 'innerHTML' of null". */
/*
If this script runs in <head> without defer/async,
document.body may not exist yet, causing:
